 ...
 */
function processLastItem(/* CODE HERE */ stingList, callback) {
  /* CODE HERE */
  return callback(stingList.pop());
}
 ...
 */
function firstNamesAllCaps(/* CODE HERE */ runner) {
  /* CODE HERE */
  let test = [];
  runner.map(upper => {
 ...
 * etc
 */
function counterMakerWithLimit(/* CODE HERE */ maximum) {
  /* CODE HERE */
  let count = 0;
  function counter() {
